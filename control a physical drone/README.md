...
on Ubuntu16
<br> If your ubuntu version is 14.04, you can also use ROS indigo which can also work. However, since indigo is too old and out of support, you can only compile and install with source code. That is annoying, so kinetic and Ubuntu16 are recommended.
